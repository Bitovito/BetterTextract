...
class BItem(BaseModel):
    ...
    measureUnit: MUnit = Field(..., description="Measure unit of the item in the bill.")
...
class BillItems(BaseModel):
    ...
    bitems: Optional[list[BItem]] = Field(default=[], description="List of items in the bill, with their name, unitary price and quantity.")
